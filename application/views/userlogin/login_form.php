...
<?php $this->load->view('sub-header-login'); ?>
...
?>
		...
		<table class="table">
			<tr>
				<td><label for="login_string" class="form_label">Username or Email</label></td>
				<td><input type="text" name="login_string" id="login_string" class="form_input" autocomplete="off" maxlength="255" /></td>
			</tr>
			<tr>
				<td><label for="login_pass" class="form_label">Password</label></td>
				<td><input type="password" name="login_pass" id="login_pass" class="form_input password" <?php 
			if( config_item('max_chars_for_password') > 0 )
				echo 'maxlength="' . config_item('max_chars_for_password') . '"'; 
		?> autocomplete="off" readonly="readonly" onfocus="this.removeAttribute('readonly');" /></td>
			</tr>
			<tr>
				<td><input type="submit" name="submit" value="Login" id="submit_button"  /></td>
				<td></td>
			</tr>
		</table>
